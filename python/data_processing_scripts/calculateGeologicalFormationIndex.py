...
def main():
    ...
    formations[["mCountLevel0", "rCountLevel0"]] = formations[["mCountLevel1", "rCountLevel1"]].apply(lambda x: x * 0)

    formations[["mCountLevel1", "rCountLevel1"]] = formations[["mCountLevel1", "rCountLevel1"]].apply(lambda x: x * 0)
