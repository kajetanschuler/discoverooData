...
for (t in 1:rows) {
  ...
  nearby_stations <- meteo_nearby_stations(lat_lon_df = city, lat_colname = "lat", lon_colname = "lon", station_data = station_data, radius = 50, var = c("TMAX", "TMIN"), year_min = 2010, year_max = 2018)
...
write.table(full_station_city_data, file = "weatherStationsByCity_50km.csv", sep = ",", append = TRUE, quote = FALSE,
